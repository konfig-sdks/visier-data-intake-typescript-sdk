...
/**
 * This class provides a wrapper for network errors when making requests to Visier Data Intake APIs
 */
export class VisierDataIntakeError extends Error {
  /**
   * The response body
   */
  ...
  constructor(axiosError: AxiosError, responseBody: unknown) {
    ...
    this.name = "VisierDataIntakeError";
